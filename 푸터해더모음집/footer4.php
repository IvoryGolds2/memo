    ...
    <div class="row">
        <div class="footer">
            <div class="footer_btn">
                <a href="index.php">
                    <img class="footer_btn_item" src="./sub/menu1-1.png">
...
<script>
  $(document).ready(function () {
      ...
      if (url.indexOf('index.php') > 0) {
          ...
          $('.footer_btn:nth-child(1) img').attr('src', './sub/menu1.png');
      } else if (url.indexOf('lh_map.php') > 0 || url.indexOf('in_article.php') > 0) {
          $('.footer_btn:nth-child(2)').addClass('active');
          $('.footer_btn:nth-child(2) img').attr('src', './sub/menu2.png');
      } else if (url.indexOf('in_article.php') > 0) {
          $('.footer_btn:nth-child(3)').addClass('active');
          $('.footer_btn:nth-child(3) img').attr('src', './sub/menu3.png');
      } else if (url.indexOf('news.php') > 0) {
          $('.footer_btn:nth-child(3)').addClass('active');
          $('.footer_btn:nth-child(3) img').attr('src', './sub/menu3.png');
      } else if (url.indexOf('index3.php') > 0) {
          $('.footer_btn:nth-child(4)').addClass('active');
          $('.footer_btn:nth-child(4) img').attr('src', './sub/menu4.png');
      }
  });
